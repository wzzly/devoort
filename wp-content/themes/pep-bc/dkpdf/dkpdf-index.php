    ...
    <head>
      	...
      	<style type="text/css">
      		body {
      			...
      			font-size: 100%;
      			background-image: url(https://www.devoort.nl/wp-content/uploads/2021/08/pdf-background-1.png); 
	    ...
	    if( $post_type == 'attachment') { ?>
		    ...
		    if ( $the_query->have_posts() ) {
		    	...
		    	while ( $the_query->have_posts() ) {
		    	    ...
		    	    <div class="dkpdf-content" style="clear: both; background-color: #fff ; padding-bottom: 30px;font-family: Source Sans Pro; padding-left: 60px; padding-right: 60px;">

		    	    	<b style="text-transform:uppercase;">Gepubliceerd: <?php echo get_the_date(); ?></b>
		    	    	<br><br>
